...
SECRET_KEY = 'django-insecure-p9sb0_1aimtj_jhv+melwdye1a7l1@(yqt(co2(9r4o6o485-h'
...
# Cache time to live is 1 hour (3600 seconds)
CACHE_TTL = 60 * 60
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('cache_metrics.log'),
